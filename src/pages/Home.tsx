...
// //                   className="inline-flex items-center space-x-2 border-2 border-white text-white px-8 py-4 rounded-lg font-semibold hover:bg-white hover:text-yellow-600 transition-colors"
...
// //                   className="w-full px-4 py-3 rounded-lg bg-white/10 border border-white/30 placeholder-gray-400 text-white focus:border-gray-400 focus:outline-none focus:ring-2 focus:ring-gray-400/50 transition-all duration-300"
// //                 />
// //                 <select className="w-full px-4 py-3 rounded-lg bg-white/10 border border-white/30 text-white focus:border-gray-400 focus:outline-none focus:ring-2 focus:ring-gray-400/50 transition-all duration-300 appearance-none">
...
//       {/* Training Section with Custom Animated Dropdown */}
//       <section className="py-20 bg-gradient-to-br from-gray-900 via-black to-gray-900 relative overflow-hidden">
//         <div className="container mx-auto px-4 relative z-10">
//           <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
...
//     className="w-full px-4 py-3 rounded-lg bg-white/10 border border-white/30 text-white cursor-pointer flex justify-between items-center"
//     whileHover={{ scale: 1.02 }}
//     whileTap={{ scale: 0.98 }}
//   >
//     <span>{programs.find(p => p.value === program)?.label || "Select Training Program"}</span>
//     <span className="transform rotate-0">{dropdownOpen ? "▲" : "▼"}</span>
//   </motion.div>
//   <AnimatePresence>
//     {dropdownOpen && (
//       <motion.ul
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <motion.div
              ...
              className="space-y-6"
            >
              <h2 className="text-3xl font-bold text-white bg-gradient-to-r from-gray-300 to-white bg-clip-text text-transparent">
                Professional Training Programs
              </h2>
              <p className="text-xl text-gray-200 leading-relaxed">
                Enhance your skills with our comprehensive training programs designed for
