        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <motion.div
              ...
              className="space-y-6"
            >
              <h2 className="text-4xl font-bold">Professional Training Programs</h2>
              <p className="text-xl text-blue-100 leading-relaxed">
              ...
              <ul className="space-y-3">
                <li className="flex items-center space-x-3">
                  ...
                  <span>GST Compliance Training</span>
                </li>
                <li className="flex items-center space-x-3">
                  <CheckCircle className="w-6 h-6 text-green-400" />
                  <span>Income Tax Practical Sessions</span>
                </li>
                <li className="flex items-center space-x-3">
                  <CheckCircle className="w-6 h-6 text-green-400" />
                  <span>Business Registration Procedures</span>
                </li>
                <li className="flex items-center space-x-3">
                  <CheckCircle className="w-6 h-6 text-green-400" />
                  <span>Digital Signature Implementation</span>
                </li>
              </ul>
            </motion.div>
            ...
            >
              <h3 className="text-2xl font-bold mb-6">Get Training Information</h3>
              <form className="space-y-4">
                ...
                <select className="w-full px-4 py-3 rounded-lg bg-white/20 border border-white/30 text-white">
                  ...
                  <option value="digital-sig">Digital Signatures</option>
                </select>
                <motion.button
                  type="submit"
